                    ...
                    <View className="bg-white rounded-t-3xl px-5 pt-6 pb-8 max-h-[85%]">
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View className="mb-4">
                                ...
                                <View className="flex-row gap-3">
                                    <TouchableOpacity
                                        ...
                                        className={`flex-1 border rounded-xl px-4 py-3 flex-row items-center ${editGender === 'Male'
                                    ...
                                    >
                                        <View
                                            className={`w-5 h-5 rounded-full border-2 mr-3 items-center justify-center ${editGender === 'Male'
                                                ? 'border-[#1A78F2]'
                                                : 'border-gray-300'
                                                }`}
                                        >
                                        ...
                                        <Text
                                            className={`font-medium ${editGender === 'Male'
                                                ? 'text-[#1A78F2]'
                                                : 'text-gray-700'
                                                }`}
                                        >
                                    ...
                                    <TouchableOpacity
                                        ...
                                        className={`flex-1 border rounded-xl px-4 py-3 flex-row items-center ${editGender === 'Female'
                                            ? 'border-[#1A78F2] bg-blue-50'
                                            : 'border-gray-300'
                                            }`}
                                        activeOpacity={0.7}
                                    ...
                                    >
                                        <View
                                            className={`w-5 h-5 rounded-full border-2 mr-3 items-center justify-center ${editGender === 'Female'
                                                ? 'border-[#1A78F2]'
                                                : 'border-gray-300'
                                                }`}
                                        >
                                        ...
                                        <Text
                                            className={`font-medium ${editGender === 'Female'
                                                ? 'text-[#1A78F2]'
                                                : 'text-gray-700'
                                                }`}
                                        >
                            ...
                            <TouchableOpacity
                                ...
                                disabled={isSaving}
                                className={`rounded-xl py-3 px-4 items-center ${isSaving ? 'bg-gray-400' : 'bg-[#1A78F2]'
                                    }`}
                                activeOpacity={0.8}
                            >
                                {isSaving ? (
